...
`BigDecimal` can represent values with a far, far greater range than the `NUMERIC` type in Oracle can.

`NUMERIC` is limited to 131,072 digits before the decimal point, and 16,384 digits after it. 
See [Section 8.1, Numeric Types] of the Oracle manual for details.
