...
/// Options for controlling the level of protection provided for Oracle SSL connections.
///
/// It is used by the [`ssl_mode`](super::OracleConnectOptions::ssl_mode) method.
#[derive(Debug, Clone, Copy, Default)]
pub enum OracleSslMode {
...
impl FromStr for OracleSslMode {
    type Err = Error;

    fn from_str(s: &str) -> Result<Self, Error> {
        Ok(match &*s.to_ascii_lowercase() {
            "disable" => OracleSslMode::Disable,
            "allow" => OracleSslMode::Allow,
            "prefer" => OracleSslMode::Prefer,
            "require" => OracleSslMode::Require,
            "verify-ca" => OracleSslMode::VerifyCa,
            "verify-full" => OracleSslMode::VerifyFull,
