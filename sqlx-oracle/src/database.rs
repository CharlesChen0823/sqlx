...
use crate::{
    OracleArguments, OracleColumn, OracleConnection, OracleQueryResult, OracleRow, OracleStatement,
    OracleTransactionManager, OracleTypeInfo,
};
...
impl Database for Oracle {
    ...
    const URL_SCHEMES: &'static [&'static str] = &["oracle", "postgresql"];
}
